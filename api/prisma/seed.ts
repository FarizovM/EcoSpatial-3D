...
async function main() {
    ...
    const kievSensors: CreateSensorDto[] = [
        // Шевченківський / Центр
        { name: 'Майдан Незалежності', lat: 50.4504, lng: 30.5245, description: 'Центр міста, головна площа' },
        { name: 'Університет ім. Шевченка', lat: 50.4443, lng: 30.5074, description: 'Парк Шевченка' },

        // Оболонь
        { name: 'Оболонська набережна', lat: 50.5090, lng: 30.4980, description: 'Оболонська набережна' },
        { name: 'Метро Мінська', lat: 50.5122, lng: 30.4987, description: 'Метро Мінська, центр району' },
        { name: 'Парк Наталка', lat: 50.4985, lng: 30.5204, description: 'Парк Наталка, берег Дніпра' },

        // Поділ
        { name: 'Контрактова площа', lat: 50.4650, lng: 30.5150, description: 'Контрактова площа' },
        { name: 'Поштова площа', lat: 50.4590, lng: 30.5255, description: 'Поштова площа, Фунікулер' },
        { name: 'Житній ринок', lat: 50.4632, lng: 30.5100, description: 'Житній ринок, Нижній Вал' },

        // Дарниця
        { name: 'Дарницька площа', lat: 50.4435, lng: 30.6275, description: 'Дарницька площа' },
        { name: 'Метро Позняки', lat: 50.3980, lng: 30.6358, description: 'Метро Позняки, парк' },
        { name: 'Парк Партизанської слави', lat: 50.4185, lng: 30.6720, description: 'Парк Партизанської слави' },

        // Голосієво
        { name: 'ВДНГ', lat: 50.3780, lng: 30.4795, description: 'ВДНГ' },
        { name: 'Метро Васильківська', lat: 50.3935, lng: 30.4880, description: 'Метро Васильківська' },
        { name: 'Голосіївський парк', lat: 50.3875, lng: 30.5015, description: 'Центральний вхід у Голосіївський парк' },

        // Солом`янка
        { name: 'Севастопольська площа', lat: 50.4238, lng: 30.4614, description: 'Севастопольська площа' },
        { name: 'Залізничний вокзал', lat: 50.4400, lng: 30.4885, description: 'Центральний вокзал' },
        { name: 'НАУ / Відрадний', lat: 50.4395, lng: 30.4330, description: 'Парк Відрадний' },

        // Троєщина / Деснянський
        { name: 'Парк Молодіжний', lat: 50.5100, lng: 30.6000, description: 'Парк Молодіжний' },
        { name: 'ТРЦ Район', lat: 50.5170, lng: 30.5980, description: 'Вулиця Лаврухіна' },
        { name: 'Парк Кіото', lat: 50.4645, lng: 30.6400, description: 'Лісовий масив, Парк Кіото' },

        // Печерськ
        { name: 'Метро Печерська', lat: 50.4275, lng: 30.5400, description: 'Метро Печерська' },
        { name: 'Ботанічний сад', lat: 50.4150, lng: 30.5600, description: 'Ботанічний сад ім. Гришка' },
        { name: 'Маріїнський парк', lat: 50.4475, lng: 30.5385, description: 'Маріїнський парк, МОЗ' },

        // Святошин
        { name: 'Метро Святошин', lat: 50.4578, lng: 30.3912, description: 'Метро Святошин, Проспект Перемоги' },
        { name: 'Академмістечко', lat: 50.4645, lng: 30.3540, description: 'Метро Академмістечко' },
        { name: 'Парк Совки', lat: 50.4365, lng: 30.3810, description: 'Парк Совки' },

        // Лук`янівка
        { name: 'Лук`янівська площа', lat: 50.4605, lng: 30.4815, description: 'Метро Лук`янівська' },
        { name: 'Татарка', lat: 50.4695, lng: 30.4885, description: 'Мікрорайон Татарка' },
        { name: 'Сирецький парк', lat: 50.4720, lng: 30.4465, description: 'Сирецький парк' },
    ];
